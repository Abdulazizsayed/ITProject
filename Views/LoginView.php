...
<body>
	<form class="form" action="http://localhost:8080/PHPWork/ITProject/Controllers/LoginController.php" method="post" onsubmit="return validation()">
		<span>Email:</span><br>
		<input id="email" name="email" placeholder="Enter Email..."><br>
